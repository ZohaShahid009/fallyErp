  ...
  <nav class="menu fixed-top pt-lg-0 d-lg-block d-none">
    ...
    <ul class="d-lg-flex align-items-center pt-lg-2" id="mynav">
      <a href="./index.html" class="logo d-none d-lg-block"><span>Fally </span>ERP</a>
      <li class="drop-down">
        <a class="border-0 btn bg-transparent apps">Apps <i class="fa-solid fa-angle-down"></i></a>
        <div class="mega-menu fadeIn animated">
          <div class="mm-6column">
            <span class="categories-list">
              <ul>
                <h5 class="products_heading_1">FINANCE</h5>
                <hr class="borderLine" />
                <a href="#" class="text-dark">Accounting</a>
      ...
      <a href="./price" class="apps">Pricing</a>
      <a href="./signin" class="apps sign_in_btn">Sign in</a>
  ...
  <nav class="navbar navbar_mbl navbar-expand-lg bg-dark d-lg-none">
    <a class="navbar-brand text-white" href="#">Fally ERP</a>
