            ...
            <div class="container">
                ...
                <div class="card card-custom position-relative overflow-hidden">
                            ...
                            <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
                                <div class="d-flex flex-column px-0 order-2 order-md-1">
                                    ...
                                    <span class="d-flex flex-column font-size-h5 font-weight-bold text-white">
                                        <span>{{$payment->client->company_name}}</span>
                                        <span>{{$payment->client->company_email}}</span>
                                        <span>{{$payment->client->company_phone}}</span>
                                    </span>
                                </div>
                                <h1 class="display-4 font-weight-boldest text-white order-1 order-md-2">Payment Received</h1>
                            </div>
                        </div>
                    </div>
                    <!--end::Invoice header-->
                    <div class="row justify-content-center py-8 px-8 py-md-30 px-md-0">
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-5 border-top pt-5 pb-3 pb-md-9">
                                    <div class="d-flex flex-column flex-md-row">
                                        <div class="d-flex flex-column">
                                            <div class="font-weight-bold font-size-h3 mb-3">{{$payment->payment_type}}</div>
                                            <div class="d-flex justify-content-between font-size-lg mb-3">
                                                <span class="font-weight-bold mr-15">Payment Date:</span>
                                                <span class="text-right">{{$payment->payment_date}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between font-size-lg mb-3">
                                                <span class="font-weight-bold mr-15">Transaction ID</span>
                                                <span class="text-right">{{$payment->transaction_id}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between font-size-lg mb-3">
                                                <span class="font-weight-bold mr-15">Received From:</span>
                                                <span class="text-right">{{$payment->client->company_name}}</span>
                                            </div>
                                            <div class="d-flex justify-content-between font-size-lg mb-3">
                                                <span class="font-weight-bold mr-15">Status:</span>
                                                <span class="text-right">{{$payment->status}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7 pt-md-10">
                                    <div class="bg-primary rounded d-flex align-items-center justify-content-between text-white max-w-350px position-relative ml-auto p-7">
                                        ...
                                        <!--end::Shape-->
                                        <div class="font-weight-boldest font-size-h5">AMOUNT RECEIVED</div>
                                        <div class="text-right d-flex flex-column">
                                            <span class="font-weight-boldest font-size-h3 line-height-sm">${{$payment->payment_amount}}.00</span>
