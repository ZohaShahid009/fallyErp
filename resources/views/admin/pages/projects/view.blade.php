                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--end::Dropdown-->
                                    <!--begin::Button-->
                                    <a href="{{ url('add-project-form') }}" class="btn btn-primary font-weight-bolder">
                                        <span class="svg-icon svg-icon-md">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="nav nav-hoverable flex-column">
                                                                <li class="nav-item"><a class="nav-link"
                                                                        href="{{ url('edit-project', $project->id) }}"><i
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        id="{{ $project->id }}" title="View details">
                                                        <i class="la la-eye"></i>
                                                    </a>
                                                    <form class="btn btn-sm btn-clean btn-icon" method="POST"
                                                        action="{{ route('delete-project', $project->id) }}">
                                                        @csrf
