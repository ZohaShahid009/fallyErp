                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--end::Dropdown-->
                                    <!--begin::Button-->
                                    <a href="{{ url('/add-client-form') }}" class="btn btn-primary font-weight-bolder">
                                        <span class="svg-icon svg-icon-md">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $i = 0;
                                        @endphp
                                         @foreach ($client as $admin)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                <td>
                                                    <img style="width:100px;margin-top:10px;" id="blah"
                                                    src="{{ asset('images/' . $admin->logo) }}">
                                                </td>
                                                <td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="nav nav-hoverable flex-column">
                                                                <li class="nav-item"><a class="nav-link"
                                                                        href="{{ url('edit-client', $admin->id) }}"><i
                                                    ...
                                                    <a href="{{ url('edit-client', $admin->id) }}"
                                                    ...
                                                    <form class="btn btn-sm btn-clean btn-icon" method="POST"
                                                        action="{{ route('delete-client', $admin->id) }}">
                                                        @csrf
