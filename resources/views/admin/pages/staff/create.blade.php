        ...
        <div class="card card-custom example example-compact">
            ...
            <form method="POST" action="{{url('add-staff')}}" class="form" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="my-5">
                        <h3 class=" text-dark font-weight-bold mb-10">profile image Details:</h3>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3"></div>
                        <div class=" mt-5 mb-5 image-input image-input-outline image-input-circle" id="kt_image_3">
                            <div class="image-input-wrapper" style="background-image: url({{ asset('/') }}uploaded_images/staff_images/blank.png)">
                            </div>
                            <label
