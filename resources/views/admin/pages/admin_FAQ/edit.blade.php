                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input name="Category_id" id="Category_id" type="text" class="form-control" value="{{ $admin->Category_id }}" />
                            </div>
                            <div class="col-lg-6">
                                <label>Tittle:</label>
                                <input name="Tittle" id="Tittle" type="text" class="form-control" value="{{ $admin->Tittle}}"  />
                            </div>
                        </div>
                        {{-- <div class="card-body">
                            <div class="form-group row">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-9 col-sm-12">
                                    <textarea class="ckeditor form-control" name="Discrption"  >{{ $admin->Discrption}}</textarea>
                                </div>
                            </div>
                        </div>
                        {{-- end zoha --}}
